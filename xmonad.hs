...
--
myLayout = avoidStruts $ windowArrange $ myDefaultLayout 
         where 
             myDefaultLayout = (tall ||| threeCol ||| monocle) 

-- default tiling algorithm partitions the screen into two panes
tall     = limitWindows 12 $ Tall nmaster delta ratio
threeCol = limitWindows 3  $ ThreeCol nmaster delta ratio
monocle  = limitWindows 20 $ Full
